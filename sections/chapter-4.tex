...
\begin{itemize}
  ...
  \item \textbf{Token-level recurrence:} the witness sets share many
        ...
        Definition~\ref{def:witness-coherence}.
\end{itemize}
...
\begin{itemize}
  ...
  \item Semantic bound: $d_{\mathrm{sem}} = 0.73 > 0.6 = \delta_{\max}$. $\times$
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Event markers} in the left margin show what happened at
        this transition: $\bullet$ spawn, $\to$ carry, $\rightsquigarrow$ drift, $\times$ rupture, $\star$ re-entry.
  \item \textbf{Ruptured themes} appear as greyed-out ``silenced'' boxes,
        showing which witnesses dispersed.
  \item \textbf{Re-entered themes} are marked with $\star$ to indicate their
